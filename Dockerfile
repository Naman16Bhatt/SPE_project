...
ENTRYPOINT service ssh start && /usr/hadoop-3.0.0/sbin/start-all.sh  &&  hdfs dfs -put /uber_combined.csv /  && hdfs dfs -put /taxi_combined.csv / && spark-submit /economics.py && bash 
